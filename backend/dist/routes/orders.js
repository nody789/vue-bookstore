...
const admin = (req, res, next) => adminOnly(req, res, next);
router.post('/', auth, (req, res) => ordersController.createOrder(req, res));
router.get('/', auth, (req, res) => ordersController.getMyOrders(req, res));
router.get('/admin', auth, admin, (req, res) => ordersController.getAllOrders(req, res));
router.get('/:id', auth, (req, res) => ordersController.getOrderById(req, res));
router.patch('/admin/:id/status', auth, admin, (req, res) => ordersController.updateOrderStatus(req, res));
