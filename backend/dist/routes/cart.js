...
router.post('/items', auth, (req, res) => cartController.addToCart(req, res));
router.patch('/items/:id', auth, (req, res) => cartController.updateCartItem(req, res));
router.delete('/items/:id', auth, (req, res) => cartController.removeCartItem(req, res));
router.delete('/', auth, (req, res) => cartController.clearCart(req, res));
